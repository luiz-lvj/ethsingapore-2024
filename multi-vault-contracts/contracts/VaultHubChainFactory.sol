...
contract VaultHubChainFactory is Ownable, OApp, OAppOptionsType3,  ERC721 {
    ...
    constructor(address _initialOwner, address _register, address _implementation, address _currency, address _endpoint)  OApp(_endpoint, _initialOwner) ERC721("VaultHubChain", "VHC") Ownable(_initialOwner)  {
